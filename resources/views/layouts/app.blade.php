            ...
            <ul class="navbar-nav ms-auto">
                ...
                @if(tienda_actual())
                    <li class="nav-item dropdown me-2">
                        <a class="nav-link dropdown-toggle" href="#" id="tiendaDropdown"
                           role="button" data-bs-toggle="dropdown">
                            <i class="bi bi-shop"></i> {{ tienda_actual()->nombre }}
                        </a>
                        <ul class="dropdown-menu dropdown-menu-end">
                            <li>
                                <a class="dropdown-item" href="{{ route('tiendas.seleccionar') }}">
                                    <i class="bi bi-arrow-repeat"></i> Cambiar Tienda
                                </a>
                            </li>
                            <li>
                                <a class="dropdown-item" href="{{ route('tiendas.index') }}">
                                    <i class="bi bi-list"></i> Mis Tiendas
                                </a>
                            </li>
                            <li><hr class="dropdown-divider"></li>
                            <li>
                                <a class="dropdown-item" href="{{ route('tiendas.create') }}">
...
<footer class="bg-light text-center text-muted py-4 mt-5">
    <div class="container">
        ...
        <small>&copy; {{ date('Y') }} - Desarrollado Por Esteban Escarraga</small>
    </div>
</footer>
